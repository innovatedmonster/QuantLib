...
# path
path_log = './log4test/'
path_log_opt_param = os.path.join(path_log, 'optimizer_param_qil_plus.log')
path_log_opt_qparam = os.path.join(path_log, 'optimizer_qparam_qil_plus.log')
path_log_model = os.path.join(path_log, 'model_qil_plus.log')
